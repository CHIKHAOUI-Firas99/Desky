...
public isSelected:boolean=false
 ...
 let k=workspace.objects
 k.forEach(element => {
    this.initialObjects.push(element.id)
 });
...
// this.objectsInCanvas.set(this.idCounter.toString(),{"id":this.idCounter,path,x,y,o,scaleX,scaleY,flipX,flipY,type,tags,material});
...
console.log(objects);
 ...
 const element = test.objects[index];
 objects[test.objects.length-1-index].x = element.left
 objects[test.objects.length-1-index].y = element.top

 // console.log("1er element"+" id "+element.id+" : [top :"+element.top+"; left : "+element.left+" ;]");
 // console.log("1er element"+" id "+objects[test.objects.length-1-index].id+" : [top :"+objects[test.objects.length-1-index].y+"; left : "+objects[test.objects.length-1-index].x+" ;]");
